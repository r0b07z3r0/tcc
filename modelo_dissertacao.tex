...
\documento{Trabalho de Conclus\~ao de Curso 2}
\nivel{Gradua\c{c}\~ao}
\titulacao{Engenheiro Eletricista}
\area{Engenharia El\'etrica}
\titulo{RASCUNHO: Proposta de conversor autom\'atico de Redes de Petri em c\'odigos implement\'aveis para desenvolvimento de projetos de automa\c{c}\~ao} % titulo do trabalho em português
...
%\input{capitulos/problema.tex}
%\input{capitulos/justificativa.tex}
%\input{capitulos/objetivos.tex}
\input{capitulos/proposta.tex}

...
Ap\'os a modelagem de sua estrutura, o pr\'oximo passo \'e definir as marca\c{c}\~oes iniciais. O conjunto de marca\c{c}\~oes iniciais \'e definido por x_0, denotada como x_0=[x(p1),x(p2),...,x(pn)], sendo x(pn) a quantidade de marca\c{c}\~oes para o lugar pn.
Assim, para o exemplo da figura \ref{fig:rdpsimplesmarcada}, o conjunto das marca\c{c}\~oes iniciais \'e x_0 = [1,0].
...
Assim obtemos o modelo completo da RdP, definida como uma qu\'intupla N = (P,T,A,$\omega$,x_0).

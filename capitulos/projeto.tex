...
Na ferramenta, o usu\'ario seleciona o arquivo de modelagem e preenche a especifica\c{c}\~ao, como mostrado na ~\ref{fig:pqnafabentrada}. O algoritmo, partindo do modelo auto\^omato da especifica\c{c}\~ao e seguindo o m\'etodo de \cite{UzamWonham2005}, gera um par de lugares com as transi\c{c}\~oes que precedem e sucedem os lugares da especifica\c{c}\~ao.
Na figura
